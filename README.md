...
- Примеры (examples): [example.pdf](https://github.com/kozyakin/kozyakin.github.io/blob/main/bibtex_to_amsbib/example/example.pdf) (in Russian) or [example_en.pdf](https://github.com/kozyakin/kozyakin.github.io/blob/main/bibtex_to_amsbib/example/example_en.pdf) (in English}
