...
- Страница проекта (link to working files): [BibTeX to AMSBIB]([https://github.com/kozyakin/kozyakin.github.io/tree/main](https://github.com/kozyakin/bibtex_to_amsbib)
