...
- Примеры (example files): [example.pdf](https://kozyakin.github.io/bibtex_to_amsbib/example/example.pdf) (in Russian) / [example_en.pdf](bibtex_to_amsbib/example/example_en.pdf) (in English}
